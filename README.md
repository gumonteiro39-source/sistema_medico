...
4. Criando o projeto django -> django-adin startproject nome_do_projeto .
...
## OBSERVAÇÕES
1. Em python, podemos ter mais de uma classe por arquivo, diferente do java.
...
DateTimeField() -> é um campo de data e hora
     ...
     -timezone.now -> é a data e hora atual
...
ImageField() -> é um campo de imagem.
     -upload_to -> é o camino onde a imagem será salva.
     -%Y é o ano
     -%m é o mês
     -%d é o dia

ForeignKey() -> é um campo de chave estrangeira.
     -on_delete=models.CASCADE -> significa que quando um paciente/medico for deletado, 
a consulta também será deletada.
